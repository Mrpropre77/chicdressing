...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/underscore.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/shortcode.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/backbone.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/wp-util.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/wp-backbone.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/media-models.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/plupload/wp-plupload.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/jquery/ui/core.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/jquery/ui/mouse.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/jquery/ui/sortable.min.js\n- Error message: "+ e.message);}
