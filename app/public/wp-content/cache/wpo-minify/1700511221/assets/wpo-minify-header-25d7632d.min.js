...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/jquery/jquery.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/jquery/jquery-migrate.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/utils.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/plupload/moxie.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://chic-dressing.local/wp-includes/js/plupload/plupload.min.js\n- Error message: "+ e.message);}
