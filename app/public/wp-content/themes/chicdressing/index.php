...
if ( is_home() ) {
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		...
		<iframe src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480" title="fashion week paris"></iframe>;
	</div>
	<?php
